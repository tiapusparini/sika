                        ...
                        <form method="POST" action="<?php echo base_url('Transaksi/prosesEditPeserta'); ?>" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                <div class="row">    
                                    ...
                                    <div class="col-lg-3">
                                        <input name="kode_jenis_peserta" value="<?php foreach ($peserta as $p) {echo $p->kode_jenis_peserta;} ?>" hidden>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="tab-pane fade" id="dataKepegawaian">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <select class="form-control" name="kelompok_peserta" id="kelompok_peserta"  required="">
                                                    ...
                                                    <?php foreach ($peserta as $p){?>
                                                        ...
                                                        <option value="<?php echo $kp->kode_kelompok_peserta; ?>" <?php echo ($p->kode_kelompok_peserta == $kp->kode_kelompok_peserta)?'selected=""':''?> ><?php echo $kp->nama_kelompok_peserta; ?></option>
                                                    <?php }} ?>
                                                </select>  
                                            </div>
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-3">
                                                <select class="form-control" name="perusahaan" id="perusahaan">
                                                    <option></option>
                                                    <?php foreach ($peserta as $p) { ?>
                                                        <?php foreach ($instansi as $i) { if($p->kode_instansi == $i->kode_instansi){ ?>
                                                        <option value="<?php echo $i->kode_instansi; ?>" selected="" ><?php echo $i->nama_instansi; ?></option>
                                                    <?php }}} ?>
                                                </select>  
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-1">
                                                <select class="form-control" name="band_posisi" id="band_posisi"  required="">
                                                    ...
                                                    <?php foreach ($peserta as $p){?>
                                                        ...
                                                        <option value="<?php echo $bp->nama_band; ?>" <?php echo ($p->kode_band_posisi == $bp->kode_band_posisi)?'selected=""':''?> ><?php echo $bp->nama_band; ?></option>
                                                    <?php } } ?>
                                            ...
                                            <div class="col-lg-1">
                                                <select class="form-control" name="klas_posisi" id="klas_posisi" required="">
                                                    <option></option>
                                                    <?php foreach ($peserta as $p) { ?>
                                                    <option value="<?php echo $p->klas_posisi; ?>" selected=""><?php echo $p->klas_posisi; ?></option>
                                                    <?php } ?>
                                                </select>  
                                            </div>
                                            <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-1">
                                                <select class="form-control" name="kelas_perawatan" id="kelas_perawatan" required="">
                                                    <option></option>
                                                    <?php foreach ($peserta as $p) { ?>
                                                        <?php foreach ($band_posisi as $bp) { if($p->kode_band_posisi == $bp->kode_band_posisi && $p->kelas_perawatan == $bp->kelas_perawatan) { ?>
                                                        <option value="<?php echo $p->kode_band_posisi; ?>" selected=""><?php echo $p->kelas_perawatan; ?></option>
                                                    <?php } } }?>
                                                </select>  
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <input class="form-control" name="jabatan" value="<?php foreach ($peserta as $p) {echo $p->jabatan;} ?>">
                                            </div>
                                            <div class="col-lg-2">
                                                ...
                                                <select class="form-control" name="pa" id="pa">
                                                    ...
                                                    <?php foreach ($peserta as $p) { ?>
                                                        <?php foreach ($personal_area as $pa) { ?>
                                                            <?php foreach ($personal_sub_area as $psa) { if($psa->kode_personal_area == $pa->kode_personal_area) { ?> 
                                                            <option value="<?php echo $pa->kode_personal_area;?>" <?php echo ($p->kode_personal_sub_area == $psa->kode && $psa->kode_personal_area == $pa->kode_personal_area)?'selected=""':''?> ><?php echo $pa->nama_personal_area; ?></option>
                                                    <?php }}}} ?>
                                                </select>  
                                            </div>
                                            <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-2">
                                                <select class="form-control" name="psa" id="psa">
                                                    <option></option>
                                                    <?php foreach ($peserta as $p) { ?>
                                                        <?php foreach ($personal_sub_area as $psarea) { if($p->kode_personal_sub_area == $psarea->kode){ ?>
                                                        <option value="<?php echo $psarea->kode; ?>" selected="" ><?php echo $psarea->nama_personal_sub_area; ?></option>
                                                    <?php }}} ?>
                                                </select>  
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <select class="form-control" name="divisi" id="divisi">
                                                    ...
                                                    <?php foreach ($peserta as $p){?>
                                                        ...
                                                        <option value="<?php echo $kd->kode_divisi; ?>" <?php echo ($p->kode_divisi == $kd->kode_divisi)?'selected=""':''?> ><?php echo $kd->nama_divisi; ?></option>
                                            ...
                                            <div class="col-lg-2">
                                                <select class="form-control" name="bagian" id="bagian">
                                                    <option></option>
                                                    <?php foreach ($peserta as $p) { ?>
                                                        <?php foreach ($bagian as $b) { if($p->kode_bagian == $b->kode_bagian){ ?>
                                                        <option value="<?php echo $b->kode_bagian; ?>" selected="" ><?php echo $b->nama_bagian; ?></option>
                                                    <?php }}} ?>
                                                </select>  
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <input class="form-control"  type="date" name="tanggal_capeg" value="<?php foreach ($peserta as $p) {echo $p->tgl_capeg;} ?>" required="">
                                            </div>
                                            <div class="col-lg-2">
                                                <p class="text-right"><label>Tgl. Mulai Kerja</label></p>
                                            </div>
                                            <div class="col-lg-2">
                                                <input class="form-control" type="date" name="tanggal_mulai_kerja" value="<?php foreach ($peserta as $p) {echo $p->tgl_mulai_kerja;} ?>">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <input class="form-control" type="date" name="tanggal_pensiun" value="<?php foreach ($peserta as $p) {echo $p->tgl_pensiun;} ?>">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                            <input class="form-control" type="date" name="tanggal_berhenti_bekerja" value="<?php foreach ($peserta as $p) {echo $p->tgl_berhenti_kerja;} ?>">
                                            </div>
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-3">
                                                <select class="form-control" name="alasan_berhenti_bekerja">
                                                    <option></option>
                                                    <option value="PENSIUN NORMAL MKERJA DIATAS 20 TH" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "PENSIUN NORMAL MKERJA DIATAS 20 TH")?'selected=""':'';}?> >PENSIUN NORMAL MKERJA DIATAS 20 TH</option>
                                                    <option value="PENSIUN NORMAL MKERJA KURANG 20 TH" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "PENSIUN NORMAL MKERJA KURANG 20 TH")?'selected=""':'';}?> >PENSIUN NORMAL MKERJA KURANG 20 TH</option>
                                                    <option value="PENSIUN NORMAL CAPEG DIATAS NOV 95" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "PENSIUN NORMAL CAPEG DIATAS NOV 95")?'selected=""':'';}?> >PENSIUN NORMAL CAPEG DIATAS NOV 95</option>
                                                    <option value="PENDI NON FASKES" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "PENDI NON FASKES")?'selected=""':'';}?> >PENDI NON FASKES</option>
                                                    <option value="PENDI FASKES" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "PENDI FASKES")?'selected=""':'';}?> >PENDI FASKES</option>
                                                    <option value="MENINGGAL DUNIA" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "MENINGGAL DUNIA")?'selected=""':'';}?> >MENINGGAL DUNIA</option>
                                                    <option value="APS MASA KERJA DIATAS 20 TH" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "APS MASA KERJA DIATAS 20 TH")?'selected=""':'';}?> >APS MASA KERJA DIATAS 20 TH</option>
                                                    <option value="APS MASA KERJA DIBAWAH 20 TH" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "APS MASA KERJA DIBAWAH 20 TH")?'selected=""':'';}?> >APS MASA KERJA DIBAWAH 20 TH</option>
                                                    <option value="HUKDIS" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "HUKDIS")?'selected=""':'';}?> >HUKDIS</option>
                                                    <option value="PENSIUN UZUR" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "PENSIUN UZUR")?'selected=""':'';}?> >PENSIUN UZUR</option>
                                                    <option value="CLTP" <?php foreach ($peserta as $p) {echo ($p->alasan_berhenti_kerja == "CLTP")?'selected=""':'';}?> >CLTP</option> 
                                                </select>  
                                            </div>
                                        </div>
                                    </div>
