        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <div class="d-flex">
                            <h5 class="card-title pt-2">Daftar Master Band Posisi Pensiunan</h5>
                            <button class="btn btn-primary ml-auto" data-toggle="modal" data-target="#ModalPekerjaan">Tambah Pekerjaan &#43;</button>    
                        </div>
                        <li class="nav-item-divider nav-item"></li>
                        <div class="d-flex justify-content-start">
                            <input type="text" id="filter-bandPensiun" name="cari" placeholder="Cari.." class="form-control col-3">
                        </div> 
                        ...
                        <table class="mb-0 table table-hover">
                            ...
                            <tbody id="data-bandPensiun">
                            <?php foreach($bandPensiun as $a){?>
                            <tr class="text-center">
                                <td scope="row"><?php echo $a->grade;?></td>
                                <td scope="row"><?php echo $a->kode_band_posisi;?></td>
                                <td><?php echo $a->nama_band;?></td>
                                <td><?php echo $a->klas_posisi;?></td>
                                <td><?php echo $a->kelas_perawatan;?></td>
                                <td scope="row"><?php echo $a->tipe;?></td>
                                <td>
